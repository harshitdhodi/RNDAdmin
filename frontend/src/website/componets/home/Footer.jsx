        ...
        <div className="max-w-[75rem] mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4">
            ...
            <div className="lg:w-[292px]">
              ...
              <ScrollLink to="/privacy-policy" className="hover:text-gray-200">Privacy Policy</ScrollLink>
                <ScrollLink to="/terms-and-conditions" className="hover:text-gray-200">Terms & Conditions</ScrollLink>
