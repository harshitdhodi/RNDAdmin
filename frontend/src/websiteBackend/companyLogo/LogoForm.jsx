                    ...
                    {[
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                            ...
                            {preview.footerLogo && (
                                <div className="mt-4 p-4 bg-white border border-gray-200 rounded-lg">
                                    <p className="text-sm text-gray-600 mb-2">Preview:</p>
                                    <img src={preview.footerLogo} alt="Footer Logo Preview" className="h-20 object-contain" />
                                </div>
                            )}
                            <input
                                type="text"
                                name="footerLogoName"
                                value={formData.footerLogoName}
                                onChange={handleInputChange}
                                placeholder="Footer Logo Name"
                                className="w-full px-4 py-2 mt-2 border border-gray-300 rounded-md focus:ring focus:ring-indigo-200"
                            />
                            <input
                                type="text"
                                name="footerLogoAltName"
                                value={formData.footerLogoAltName}
                                onChange={handleInputChange}
                                placeholder="Footer Logo Alt Name"
                                className="w-full px-4 py-2 mt-2 border border-gray-300 rounded-md focus:ring focus:ring-indigo-200"
                            />
                        </div>
                     ...
                     <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                            ...
                            <label htmlFor="tagline"  className="block text-sm font-semibold text-gray-700 mb-2">Tagline</label>
                            <input
                                type="text"
                                id="tagline"
                                name="tagline"
